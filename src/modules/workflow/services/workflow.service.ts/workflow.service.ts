...
import { LoggerService } from 'src/core/logger/logger.service'; // IMPORTANTE
...
export class WorkflowService {
    constructor(
        ...
        private logger: LoggerService, // INYECTAMOS el Logger
    ) { }
    ...
    async executeWorkflow(
        ...
        this.logger.debug(`variable name_flujo: ${name_flujo}`)
        this.logger.debug(`variable urlevo: ${urlevo}`)
        this.logger.debug(`variable apikey: ${apikey}`)
        this.logger.debug(`variable instanceName: ${instanceName}`)
        this.logger.debug(`variable remoteJid: ${remoteJid}`)
        this.logger.log(`Ejecutando workflow: ${name_flujo}`, 'WorkflowService');
